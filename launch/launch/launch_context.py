...
class LaunchContext:
    ...
    def extend_globals(self, extensions: Dict[Text, Any]):
        """
    ...
    def extend_locals(self, extensions: Dict[Text, Any]):
    ...
    def would_handle_event(self, event: Event):
    ...
    def unregister_event_handler(self, event_handler: EventHandler):
        """Unregister an event handler."""
        self._event_handlers.remove(event_handler)

    def emit_event_sync(self, event: Event):
    ...
    def perform_substitution(self, substitution: Substitution):
